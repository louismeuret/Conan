#!/usr/bin/env /home/louis/MGLTools-1.5.7 (copie)/bin/pythonsh
#
# 
#
...
select = [m for m in after if not m in before]

content = [x for x in select if not x.startswith('numpy')]

end = list(dict.fromkeys(content))
print(end)
